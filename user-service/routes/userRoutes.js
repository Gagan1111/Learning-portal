...
router.get(`${apiVersion}/users/:id`,authenticateToken, userController.getUserDetails);
router.put(`${apiVersion}/users/:id`, authenticateToken,userController.updateUserDetails);
